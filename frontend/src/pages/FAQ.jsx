  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Email us at support@raze.com with your order number and reason for return. We'll send you return instructions within 24 hours."
      }
    ]
  },
  {
    ...
    <div className="faq-page">
      <div className="container">
        ...
        <div className="faq-contact">
          ...
          <a href="mailto:support@raze.com" className="faq-contact-btn">
            Contact Support
          </a>
        </div>
      </div>
